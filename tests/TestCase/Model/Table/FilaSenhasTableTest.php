...
use App\Model\Table\FilaSenhasTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FilaSenhasTable Test Case
 */
class FilaSenhasTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\FilaSenhasTable     */
    public $FilaSenhas;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FilaSenhas') ? [] : ['className' => FilaSenhasTable::class];        $this->FilaSenhas = TableRegistry::get('FilaSenhas', $config);    }
